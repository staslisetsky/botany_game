...
InitOpengl()
{
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(vertex_xyzrgba) * VERTEX_BUFFER_SIZE, 0, GL_DYNAMIC_DRAW);
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(vertex_xyzrgbauv) * VERTEX_BUFFER_SIZE, NULL, GL_DYNAMIC_DRAW);
    glEnableVertexAttribArray(0);
    glEnableVertexAttribArray(1);
